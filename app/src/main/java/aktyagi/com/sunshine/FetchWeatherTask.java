...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitType = sharedPrefs.getString(
                mContext.getString(R.string.preference_unit),
                mContext.getString(R.string.preferences_metric_default_value));

        if (unitType.equals(mContext.getString(R.string.preferences_metric_imperial_value))) {
            high = (high * 1.8) + 32;
            low = (low * 1.8) + 32;
        } else if (!unitType.equals(mContext.getString(R.string.preferences_metric_metric_value))) {
