...
public class Utility {
    public static String getPreferredLocation(Context context) {
        ...
        return prefs.getString(context.getString(R.string.preference_location),
                context.getString(R.string.preference_location_default));
    }

    public static boolean isMetric(Context context) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        return prefs.getString(context.getString(R.string.preference_unit),
                context.getString(R.string.preferences_metric_metric_value))
                .equals(context.getString(R.string.preferences_metric_metric_value));
    }
